            ...
            >
                ...
                <div className="space-y-6 mb-10">
                    {rules.map((rule, i) => (
                        ...
                        >
                            <div className="mt-1">
                                <rule.icon className="w-6 h-6 text-blue-400" />
                            </div>
                            <div>
                ...
                <div className="flex items-center gap-3 p-4 bg-blue-900/20 border border-blue-500/30 rounded-xl mb-8 cursor-pointer hover:bg-blue-900/30 transition-colors" onClick={() => setAgreed(!agreed)}>
                    <div className={`w-6 h-6 rounded flex items-center justify-center border transition-all ${agreed ? "bg-blue-600 border-blue-500" : "bg-[#0a0b1e] border-white/20"}`}>
                ...
                <button
                    ...
                    className="btn-primary flex items-center justify-center gap-2 w-full py-4 text-lg bg-gradient-to-r from-blue-600 to-indigo-600"
                >
